<script lang="ts">
  ...
  import { openModals, view } from "$lib/stores";
  import Encyclopedia from "../Modals/Encyclopedia/Encyclopedia.svelte";
...
<div class="map-controls">
  <button
    ...
    on:click={() => {
      ...
      if ($openModals.Encyclopedia == null) {
        let pages = {};
        pages[id] = newPage;
        $openModals.Encyclopedia = pages;
      } else {
        $openModals.Encyclopedia = { [id]: newPage };
      }
    }}
    title="Encyclopedia">
    <svg
